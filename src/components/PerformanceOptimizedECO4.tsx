...
interface PerformanceOptimizedECO4Props {
  scrollY: number;
}

// Critical hero component with optimal LCP performance
const PerformanceOptimizedECO4 = ({ scrollY }: PerformanceOptimizedECO4Props) => {
  ...
  useEffect(() => {
    ...
    preloadLink.href = '/lovable-uploads/1932c2a7-9b3e-46a2-8e62-d0fabe9d2ade.png';
  ...
  return (
    <section className="relative text-white overflow-hidden min-h-screen lg:min-h-screen">
      {/* Critical path optimized background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center min-h-[calc(100vh-4rem)] lg:min-h-0">
          ...
          {/* TEXT CONTENT - ALWAYS SECOND ON MOBILE - This is the LCP element */}
          <div className="order-2 lg:order-1 w-full text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
             ...
             {/* LCP Critical Text - Optimized for fastest rendering */}
...
export default PerformanceOptimizedECO4;